...
#ifndef SMPDUDN_REQUEST_CONTAINER_H_
#define SMPDUDN_REQUEST_CONTAINER_H_
...
#define SMPDUDN_REQUEST_CONTAINER_MINIMUM_LENGTH_TLV 3
#define SMPDUDN_REQUEST_CONTAINER_MAXIMUM_LENGTH_TLV 255
