...
extern asn_SEQUENCE_specifics_t asn_SPC_Ngap_UplinkRIMInformationTransferIEs_specs_425;
...
extern asn_SEQUENCE_specifics_t asn_SPC_Ngap_DownlinkRIMInformationTransferIEs_specs_429;
