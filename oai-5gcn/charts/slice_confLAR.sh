...
do
	...
	do
		...
		do
			...
			sed -i "/ngapIPadd/c\  ngapIPadd: \"192.168.$gnbsimt1.$gnbsimI\"" oai-gnbsim/values.yaml
			sed -i "/gtpIPadd/c\  gtpIPadd: \"192.168.$gnbsimt2.$gnbsimI\"" oai-gnbsim/values.yaml
			sed -i "/gtpulocaladdr/c\  gtpulocaladdr: \"192.168.$gnbsimt1.$gnbsimI\"" oai-gnbsim/values.yaml
			...
			if [[ sim  -ge 100 ]];
			then
				sed -i "/key/c\  key: \"0C1A34601D4F07677303652C04625$gnbsimc\"" oai-gnbsim/values.yaml
				sed -i "/msin/c\  msin: \"1000000$gnbsimc\"" oai-gnbsim/values.yaml
			else
